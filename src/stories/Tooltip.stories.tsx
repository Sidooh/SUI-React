...
stories.add('Tooltip', () => {
    return (
        <Card>
            ...
            <Card.Body className={'d-flex justify-content-center p-5'}>
                <Tooltip
                    title={`Congratulations! You have received Ksh100.00 airtime from Sidooh account 254723604233 on 06/09/22, 7:05 AM. Sidooh Makes You Money with Every Purchase. Dial *384*99# NOW for FREE on your Safaricom line to BUY AIRTIME & START EARNING from your purchases.`}
                    placement={'left'}>
                    <Button className={'me-1'}>Tooltip Left</Button>
                </Tooltip>
            </Card.Body>
